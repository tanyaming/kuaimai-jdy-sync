...
(async()=>{
  // 5972733877893144 这批 sid 大概 8/12，查 8/12 sys 订单
  const r=await reqKm({startTime:'2026-08-12 00:00:00',endTime:'2026-08-12 23:59:59',timeType:'created',pageNo:1,pageSize:200});
  const sys=(r.list||[]).filter(o=>o.source==='sys');
  console.log('8/12 sys 订单',sys.length,'单');
  for(const o of sys){
